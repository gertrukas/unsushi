...
export class RoleDetailsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private apiService: RoleService, private apiServiceU: UserService) { }
    ...
    this.route.params.subscribe(params => {
      ...
      this.datatableConfig = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          this.apiService.getUsers(id).subscribe(resp => {
              callback({
                data: resp.data || [],
        ...
        columns: [
          ...
          {
            title: 'Fecha de union', data: 'created_at', render: function (data) {
